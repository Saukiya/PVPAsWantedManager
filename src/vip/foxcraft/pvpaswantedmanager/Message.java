...
public class Message {
	...
	static public void createCNMessage(){
		...
		messages.set("asWantedGui.guiName", String.valueOf("&c&l通缉任务列表"));
		messages.set("asWantedGui.wantedSkull.Name", String.valueOf("&5{0} &c通缉犯"));
		messages.set("asWantedGui.wantedSkull.Online", String.valueOf("&e在线"));
		...
		messages.set("asWantedGui.gettargetMessage", String.valueOf("&8[&c通缉&8] &7你正在通缉 &c{0} &7玩家!"));
		messages.set("asWantedGui.hastargetMessage", String.valueOf("&8[&c通缉&8] &7你已经在通缉 &c{0} &7玩家了!"));
		messages.set("asWantedGui.info.Name", String.valueOf("&b{0}"));
		...
		messages.set("asWantedGui.cancellTarget.name", String.valueOf("放弃任务"));
